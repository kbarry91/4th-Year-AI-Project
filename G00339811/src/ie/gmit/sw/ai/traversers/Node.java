...
public class Node { // Taken from the maze generation labs.
	...
	/**
	 * Checks if the node has a direction from its current position in the maze by
	 * checking it's children nodes and then return the result
	 * 
	...
	/**
	 * The search heuristic used by algorithm that implement a heuristic search
	 * process
	 * 
